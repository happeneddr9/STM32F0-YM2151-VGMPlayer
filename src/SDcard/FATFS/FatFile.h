/**
 * @Name    : FatFile.h
 * @Date    : 2020年1月1日 下午2:20:46
 * @Author  : happe
 * @brief   :
 */

#ifndef SDCARD_FATFS_FATFILE_H_
#define SDCARD_FATFS_FATFILE_H_
...
//==============================================================================
	...
	class FatFile {
		public:
			 ...
			 * the value false is returned for failure.
			 */
			bool timestamp(uint8_t flags, uint16_t year, uint8_t month, uint8_t day, uint8_t hour,
