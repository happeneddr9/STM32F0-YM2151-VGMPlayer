/**
 * @Name    : FatStructs.h
 * @Date    : 2020年1月1日 下午1:43:31
 * @Author  : happe
 * @brief   :
 */

#ifndef SDCARD_FATFS_FATSTRUCTS_H_
#define SDCARD_FATFS_FATSTRUCTS_H_
...
namespace SDCard {
	...
	struct fat32_boot {
			 ...
			 * This field is only defined for FAT32 media and does not exist on
			 * FAT12 and FAT16 media.
			 * Bits [3:0]	-- Zero-based number of active FAT.
			 * 				   Only valid if mirroring is disabled.
			 * Bits [6:4]	-- Reserved.
			 * Bit [7]		-- 0 means the FAT is mirrored at runtime into all FATs.
...
#endif /* SDCARD_FATFS_FATSTRUCTS_H_ */
