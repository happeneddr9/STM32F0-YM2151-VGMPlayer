/**
 * @Name    : Nvic.hpp
 * @Date    : 2019年11月24日 下午4:33:59
 * @Author  : happe
 * @brief   :
 */

#ifndef SYSTEM_NVIC_HPP_
#define SYSTEM_NVIC_HPP_
...
class Nvic {
	...
	public:
		...
		static void configureIrq(uint8_t interrupt, FunctionalState state = ENABLE,
...
inline void Nvic::configureIrq(uint8_t interrupt, FunctionalState state, uint8_t preemptionPriority,
		uint8_t /* subPriority */) {
